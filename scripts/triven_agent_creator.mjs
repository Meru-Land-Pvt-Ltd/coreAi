...
export const AGENTS = [
  ...
  { industry: "Healthcare", subindustry: "Eye Clinics", name: "Eye Care AI Receptionist", tagline: "Make eye exam and vision-care scheduling simple from the first hello.", fullDescription: "Make it easy for patients to arrange eye exams, consultations, and other approved vision-care services. The Eye Care AI Receptionist clarifies the requested appointment type, shares verified preparation and clinic information, checks provider calendars, books the selected time, and offers a consent-based SMS confirmation. Clinical symptoms, prescriptions, test interpretation, and urgent eye concerns remain with qualified staff or emergency services according to the clinic's rules.", bookingLabel: "Eye care appointment", purpose: "Handle eye-care inquiries, exam scheduling, provider availability, and administrative FAQs.", intake: ["service or exam needed", "new or existing patient", "preferred date and time"], templateType: "Appointment Booking" },
  { industry: "Healthcare", subindustry: "Orthopedic Clinics", name: "Orthopedic Appointment AI", tagline: "Organize orthopedic referrals, consultations, and follow-ups without phone-tag.", fullDescription: "The Orthopedic Appointment AI streamlines calls for new consultations, referrals, post-operative follow-ups, and clinic-approved appointment types. It captures the relevant body area and administrative context, answers verified policy questions, checks provider availability, books the chosen slot, and confirms it after consent. It does not assess injuries, interpret imaging, recommend treatment, or determine urgency; clinical and emergency concerns are escalated using the clinic's approved instructions.", bookingLabel: "Orthopedic appointment", purpose: "Handle orthopedic appointment requests, administrative intake, provider availability, and scheduling.", intake: ["body area or appointment type", "new or existing patient", "preferred date and time"], templateType: "Appointment Booking" },
  { industry: "Healthcare", subindustry: "Physiotherapy Clinics", name: "Physiotherapy AI Assistant", tagline: "Fill therapy calendars with smoother intake, recurring visits, and helpful answers.", fullDescription: "Support prospective and existing physiotherapy patients from initial enquiry through scheduled care. The Physiotherapy AI Assistant distinguishes consultations from follow-up or recurring visits, answers business-approved service and preparation questions, checks the connected calendar, and books an appropriate appointment. It keeps the conversation administrative, never creates treatment or exercise plans, and escalates clinical questions, worsening symptoms, accessibility needs, and exceptions to clinic staff.", bookingLabel: "Physiotherapy appointment", purpose: "Handle physiotherapy inquiries, initial consultations, recurring appointment scheduling, and administrative FAQs.", intake: ["therapy or consultation type", "new or existing patient", "preferred date and time"], templateType: "Appointment Booking" },
  { industry: "Healthcare", subindustry: "Mental Health Clinics", name: "Therapy AI Assistant", tagline: "Offer a calm, private first step toward the right therapy consultation.", fullDescription: "The Therapy AI Assistant provides a respectful administrative welcome for people seeking therapy services. It explains verified clinic offerings and policies, gathers minimal scheduling information, checks therapist availability, and books consultations without attempting assessment, counselling, or diagnosis. Privacy-sensitive details are limited to what the clinic requires, while crisis language, immediate danger, clinical questions, billing issues, and requests for a human are routed to configured crisis or staff resources.", bookingLabel: "Therapy consultation", purpose: "Handle administrative therapy inquiries, therapist availability, consultation scheduling, and non-clinical FAQs.", intake: ["appointment type", "new or existing client", "preferred date and time"], templateType: "AI Receptionist", sensitive: true, mentalHealth: true },
  { industry: "Healthcare", subindustry: "Diagnostic Labs", name: "Lab Appointment AI", tagline: "Help patients prepare correctly and book the right lab visit with less waiting.", fullDescription: "The Lab Appointment AI manages calls about specimen collection, diagnostic services, operating hours, referrals, and test preparation using only laboratory-approved information. It identifies the requested test or service, checks whether an order is required, finds an available time, and books the lab visit with an optional confirmation text. It never interprets results or invents preparation instructions, and it escalates unclear orders, clinical questions, urgent concerns, and unavailable services to lab staff.", bookingLabel: "Lab appointment", purpose: "Handle diagnostic lab scheduling, test preparation information supplied by the business, hours, and administrative FAQs.", intake: ["test or service requested", "referral or order status if applicable", "preferred date and time"], templateType: "Appointment Booking" },
  { industry: "Healthcare", subindustry: "Cosmetic Surgery Clinics", name: "Cosmetic Surgery Consultation AI", tagline: "Convert procedure interest into informed, well-qualified consultation bookings.", fullDescription: "Turn cosmetic procedure enquiries into organized consultation opportunities while preserving clear clinical boundaries. The Cosmetic Surgery Consultation AI identifies the caller's area of interest and goals, answers only approved questions about the clinic and consultation process, checks availability, books the consultation, and records consent before any text confirmation. It never determines candidacy, promises results, quotes unverified prices, or gives medical advice, and it escalates complications and sensitive concerns to qualified staff.", bookingLabel: "Cosmetic surgery consultation", purpose: "Qualify cosmetic procedure interest administratively, answer business-approved FAQs, and book consultations.", intake: ["procedure of interest", "consultation goal", "preferred date and time"], templateType: "Lead Follow-Up" },
  { industry: "Healthcare", subindustry: "Plastic Surgery Clinics", name: "Plastic Surgery AI Receptionist", tagline: "Give prospective patients a polished path from enquiry to surgeon consultation.", fullDescription: "The Plastic Surgery AI Receptionist handles inbound interest in clinic-approved surgical and non-surgical services with a professional, discreet tone. It shares verified consultation information, collects the procedure interest and scheduling goal, checks calendar availability, books a consultation, and arranges follow-up when necessary. The agent does not assess candidacy, interpret photos, guarantee outcomes, or provide clinical guidance; medical, pricing, financing, and post-procedure concerns go to the clinic team.", bookingLabel: "Plastic surgery consultation", purpose: "Handle plastic surgery inquiries, non-clinical procedure FAQs, consultation scheduling, and follow-up routing.", intake: ["procedure of interest", "consultation goal", "preferred date and time"], templateType: "AI Receptionist" },
  { industry: "Healthcare", subindustry: "Chiropractic Clinics", name: "Chiropractic Booking AI", tagline: "Welcome new and returning patients, then secure the right chiropractic visit.", fullDescription: "The Chiropractic Booking AI keeps the front desk moving by handling new-patient enquiries, returning-patient scheduling, availability checks, and approved clinic FAQs. It captures the administrative reason for the appointment, offers suitable open times, books the confirmed slot, and sends a text only after consent. It never diagnoses pain, recommends adjustments, or claims a treatment outcome, and it routes injury concerns, severe symptoms, billing questions, and policy exceptions to a person.", bookingLabel: "Chiropractic appointment", purpose: "Handle new-patient inquiries, administrative intake, availability checks, and chiropractic appointment booking.", intake: ["appointment reason", "new or existing patient", "preferred date and time"], templateType: "Appointment Booking" },
  { industry: "Healthcare", subindustry: "Urgent Care Centers", name: "Urgent Care AI Assistant", tagline: "Share verified urgent-care access details without crossing into medical triage.", fullDescription: "The Urgent Care AI Assistant answers non-clinical questions about location, hours, accepted visit types, administrative policies, and configured scheduling options. It collects only basic visit information, checks availability when the center supports appointments, and books or routes the caller to the correct operational next step. It never estimates wait times without live data, evaluates symptoms, or decides whether care is urgent; emergency or uncertain medical situations are directed to local emergency services or approved staff guidance.", bookingLabel: "Urgent care visit", purpose: "Handle non-emergency administrative inquiries, hours, availability, and visit scheduling without providing medical triage.", intake: ["administrative reason for visit", "patient name", "preferred arrival or appointment time"], templateType: "AI Receptionist", sensitive: true },
  { industry: "Healthcare", subindustry: "Pediatric Clinics", name: "Pediatric Clinic AI", tagline: "Make pediatric scheduling easier for parents and guardians, day or night.", fullDescription: "The Pediatric Clinic AI gives parents and guardians a reliable administrative line for well visits, follow-ups, vaccinations, and other clinic-approved appointment types. It gathers minimal booking details, answers verified office questions, checks the pediatric calendar, reserves a confirmed slot, and offers an SMS confirmation with consent. It does not assess a child's symptoms, recommend medication, or provide clinical advice, and it immediately follows clinic escalation rules for urgent or emergency concerns.", bookingLabel: "Pediatric appointment", purpose: "Handle parent or guardian calls, pediatric appointment scheduling, provider availability, and administrative FAQs.", intake: ["child appointment type", "new or existing patient", "preferred date and time"], templateType: "AI Receptionist", sensitive: true },
  { industry: "Healthcare", subindustry: "Cardiology Clinics", name: "Cardiology AI Receptionist", tagline: "Coordinate cardiology referrals and visits with careful, non-clinical intake.", fullDescription: "The Cardiology AI Receptionist supports referral enquiries, new-patient consultations, follow-ups, and clinic-approved diagnostic appointments. It explains verified administrative requirements, collects the appointment or referral type, checks provider availability, books the chosen time, and confirms next steps. It never interprets cardiac symptoms or test results, offers treatment advice, or delays emergency care; chest pain, breathing difficulty, immediate danger, and other urgent concerns trigger the clinic's emergency direction.", bookingLabel: "Cardiology appointment", purpose: "Handle cardiology administrative inquiries, referral and appointment questions, availability, and scheduling.", intake: ["appointment or referral type", "new or existing patient", "preferred date and time"], templateType: "AI Receptionist", sensitive: true },
  { industry: "Healthcare", subindustry: "Dermatology Clinics", name: "Dermatology AI Assistant", tagline: "Route medical and cosmetic skin enquiries into the right consultation slot.", fullDescription: "The Dermatology AI Assistant helps callers navigate medical dermatology visits, cosmetic consultations, follow-ups, and other services the clinic has approved. It clarifies the requested appointment type, shares verified preparation and policy details, checks availability, books the visit, and offers a consent-based confirmation text. It never diagnoses a skin concern, evaluates photos, recommends products or treatment, or promises results, and it escalates urgent symptoms and clinical questions to qualified staff.", bookingLabel: "Dermatology consultation", purpose: "Handle dermatology appointment inquiries, treatment-service FAQs approved by the clinic, and consultation scheduling.", intake: ["appointment or service type", "new or existing patient", "preferred date and time"], templateType: "AI Receptionist" },
  { industry: "Healthcare", subindustry: "ENT Clinics", name: "ENT Appointment AI", tagline: "Match ear, nose, and throat appointment needs to available clinic times.", fullDescription: "The ENT Appointment AI handles administrative calls for consultations, referrals, hearing-related services, follow-ups, and other configured appointment types. It captures the visit category, answers clinic-approved questions, checks the connected calendar, books a confirmed time, and provides clear next-step messaging. It does not diagnose symptoms, assess severity, interpret tests, or recommend treatment, and it directs emergencies, post-procedure concerns, and uncertain clinical requests to staff.", bookingLabel: "ENT appointment", purpose: "Handle ENT administrative inquiries, provider availability, appointment types, and scheduling.", intake: ["appointment reason", "new or existing patient", "preferred date and time"], templateType: "Appointment Booking" },
  { industry: "Healthcare", subindustry: "Fertility Clinics", name: "Fertility Consultation AI", tagline: "Create a discreet, reassuring path to the right fertility consultation.", fullDescription: "The Fertility Consultation AI offers a sensitive administrative first contact for people exploring clinic services or arranging follow-up. It shares only approved information, asks for minimal scheduling details, identifies the consultation type, checks availability, books the selected time, and arranges human follow-up when needed. It never assesses fertility, interprets results, recommends treatment, or predicts outcomes, and it protects the conversation by avoiding unnecessary personal or medical details.", bookingLabel: "Fertility consultation", purpose: "Handle fertility-clinic administrative inquiries, consultation scheduling, business-approved FAQs, and follow-up routing.", intake: ["consultation type", "new or existing patient", "preferred date and time"], templateType: "Lead Follow-Up", sensitive: true },

  // Real Estate (2)
  { industry: "Real Estate", subindustry: "Residential Real Estate", name: "Residential Property AI Agent", tagline: "Qualify serious property enquiries and book viewings while interest is high.", fullDescription: "The Residential Property AI Agent responds to buyers, sellers, renters, and investors as soon as they call. It captures intent, location, property type, budget range, and timeline; answers brokerage-approved questions; and schedules a viewing or agent consultation in the connected calendar. It never invents listing availability, valuations, financing terms, or contract details, and it sends uncertain property, legal, negotiation, and offer-related requests to the responsible agent.", bookingLabel: "Property viewing or consultation", purpose: "Qualify residential buyer, seller, renter, or investor inquiries and schedule property viewings or agent consultations.", intake: ["buyer, seller, renter, or investor intent", "preferred location and property type", "budget range and timeline"], templateType: "Lead Follow-Up" },
  { industry: "Real Estate", subindustry: "Commercial Real Estate", name: "Commercial Property AI Agent", tagline: "Capture complex space requirements and connect prospects with the right broker.", fullDescription: "The Commercial Property AI Agent turns inbound leasing, acquisition, disposition, and investment calls into structured broker opportunities. It gathers the property use, market, size, budget, timing, and other business requirements, provides only verified firm or listing information, and schedules consultations or tours. Availability, zoning, financial returns, valuations, legal status, and commercial terms are never assumed; those decisions and negotiations are escalated to a qualified broker.", bookingLabel: "Commercial property consultation", purpose: "Qualify commercial property requirements and schedule broker consultations, property tours, or follow-up meetings.", intake: ["lease, purchase, sale, or investment intent", "property type and location", "budget, size, and timeline"], templateType: "Lead Follow-Up" },

  // Automotive (3)
  { industry: "Automotive", subindustry: "Car Dealerships", name: "Vehicle Sales AI Agent", tagline: "Move vehicle shoppers from first question to a scheduled test drive faster.", fullDescription: "The Vehicle Sales AI Agent answers inbound dealership calls, qualifies new or used vehicle interest, and keeps shoppers engaged outside showroom hours. It uses verified dealership data to discuss models, policies, and available sales services, then schedules a test drive or sales appointment and offers a confirmation text. It never fabricates inventory, final pricing, trade-in values, incentives, financing approval, or delivery dates, and it routes deal-specific questions to the sales team.", bookingLabel: "Test drive or sales appointment", purpose: "Handle vehicle inquiries, qualify buyer interest, answer approved dealership FAQs, and schedule test drives or sales appointments.", intake: ["vehicle or model interest", "new or used preference", "purchase timeline and appointment preference"], templateType: "Lead Follow-Up" },
  { industry: "Automotive", subindustry: "Auto Service Centers", name: "Vehicle Service Booking AI", tagline: "Capture the vehicle details once and book the right service bay appointment.", fullDescription: "The Vehicle Service Booking AI handles maintenance and repair enquiries with consistent intake. It records the vehicle year, make, model, requested service or reported issue, explains only service-center-approved policies, checks the calendar, and books an available service appointment. The agent does not diagnose mechanical faults, guarantee parts or completion times, or quote unverified prices; unsafe vehicle reports, roadside situations, warranty disputes, and unusual repairs are escalated to staff.", bookingLabel: "Vehicle service appointment", purpose: "Handle vehicle-service calls, collect basic vehicle and service details, check availability, and book service appointments.", intake: ["vehicle year, make, and model", "requested service or reported issue", "preferred date and time"], templateType: "Appointment Booking" },
  { industry: "Automotive", subindustry: "Car Rental Services", name: "Car Rental Reservation AI", tagline: "Turn rental questions into complete, policy-aware reservation requests.", fullDescription: "The Car Rental Reservation AI gathers pickup and return dates, location, vehicle category, and approved accessibility or equipment requirements from inbound callers. It answers verified questions about age, identification, deposits, mileage, fuel, and cancellation policies, then schedules or records the configured reservation next step. It never promises fleet availability, a specific model, final pricing, eligibility, or a confirmed external reservation unless connected business data explicitly verifies it.", bookingLabel: "Car rental reservation consultation", purpose: "Handle rental inquiries, collect reservation requirements, answer approved policies, and schedule or request reservations based on configured availability.", intake: ["pickup and return dates", "pickup location", "vehicle category or requirements"], templateType: "AI Receptionist" },

  // Legal (2)
  { industry: "Legal", subindustry: "Law Firms", name: "Legal Receptionist AI", tagline: "Capture prospective-client needs discreetly and schedule the right legal consultation.", fullDescription: "The Legal Receptionist AI gives prospective clients a professional first response while keeping intake controlled. It identifies the broad matter category, records a brief non-confidential summary and contact details, answers only firm-approved administrative questions, and schedules a consultation. It never provides legal advice, predicts outcomes, promises representation, or creates an attorney-client relationship, and it directs deadlines, conflicts, emergencies, confidential disclosures, and case-specific questions to firm staff.", bookingLabel: "Legal consultation", purpose: "Handle prospective-client intake, identify the legal matter at a high level, collect contact details, and schedule consultations without giving legal advice.", intake: ["legal matter category", "brief non-confidential summary", "preferred consultation date and time"], templateType: "AI Receptionist" },
  { industry: "Legal", subindustry: "Notary Services", name: "Notary Appointment AI", tagline: "Prepare signers with approved requirements and book the right notary appointment.", fullDescription: "The Notary Appointment AI organizes calls for acknowledgements, jurats, certified copies, mobile visits, and other services the business has configured. It collects the document or service type, signer count, location needs, and preferred time, shares verified identification and witness requirements, and books the appointment. It does not select notarial acts, draft documents, determine legal sufficiency, or guarantee eligibility, and it sends document-specific legal questions and unusual requests to the notary.", bookingLabel: "Notary appointment", purpose: "Handle notary-service inquiries, collect document and appointment requirements, answer approved FAQs, and schedule notary appointments.", intake: ["document or notary service type", "number of signers if relevant", "preferred date and time"], templateType: "Appointment Booking" }
];
...
export function resolveIconDirectory() {
  const candidates = [
...
export function loadAgentIconDataUrl(agent, iconDirectory) {
...
export function buildTagline(agent) {
  const tagline = String(agent.tagline || "").replace(/\s+/g, " ").trim();
  if (tagline.length < 10) throw new Error(`Tagline is too short for ${agent.name}`);
...
export function makeWorkflow(agent) {
...
export function commonBuyerSetup(agent) {
  const fields = [
...
export function configure(agent, workflowJson, iconUrl, complianceChecked = false) {
  const tagline = buildTagline(agent);
  const fullDescription = String(agent.fullDescription || "").replace(/\s+/g, " ").trim();
  if (fullDescription.length < 100 || fullDescription.length > 2000) {
    throw new Error(`Full description for ${agent.name} must be between 100 and 2,000 characters`);
  }
