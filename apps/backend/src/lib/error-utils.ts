...
export type ApiErrorStatus = 400 | 401 | 402 | 403 | 404 | 409 | 410 | 413 | 422 | 428 | 429 | 500 | 503;

const API_ERROR_STATUSES = new Set<number>([400, 401, 402, 403, 404, 409, 410, 413, 422, 428, 429, 500, 503]);
