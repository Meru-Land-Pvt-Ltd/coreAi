...
/* The rest of this file — PLATFORM_VOICE_RUNTIME_POLICY, the compact business
   context, the session context and buildUnifiedVoiceSystemPrompt — belonged to
   a second voice runtime that never ran. It was removed with that runtime on
   2026-08-27; nothing outside this file had ever called any of it. What
   remains above is what prompt-builder.ts actually uses. */
