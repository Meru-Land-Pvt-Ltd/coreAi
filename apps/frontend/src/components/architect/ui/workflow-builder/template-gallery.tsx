...
export function TemplateGallery({
  ...
  return (
    <div
      className="scroll-thin absolute inset-0 z-10 overflow-y-auto overflow-x-hidden bg-white/95 px-4 py-5 backdrop-blur sm:px-5 sm:py-6"
      data-testid="template-gallery"
    >
      <div className="mx-auto w-full max-w-full">
        <div className="mb-1 flex flex-wrap items-center gap-2">
          <h2 className="text-base font-black text-slate-900 sm:text-lg" data-testid="template-gallery-title">Template Gallery</h2>
              ...
              >
                ...
                <div className="mt-3 flex flex-col gap-2 sm:flex-row">
                  ...
                  <button
                    ...
                    className="rounded-lg border border-gray-200 px-3 py-2 text-xs font-semibold text-slate-600 transition hover:border-violet-300 hover:text-slate-800 sm:flex-none"
                  >
                    Preview
                  </button>
                </div>
