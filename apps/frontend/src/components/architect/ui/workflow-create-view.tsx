  ...
  return (
    <div className="mx-auto grid min-h-[calc(100vh-48px)] w-full max-w-6xl items-center gap-8 py-4 lg:grid-cols-[1fr_420px]">
      <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm sm:p-8 lg:p-10">
        <span className="inline-flex rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-black uppercase tracking-[0.18em] text-amber-700">
          New agent
        </span>
        <h1 className="mt-5 max-w-2xl text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
      ...
      <aside className="rounded-[2rem] border border-amber-100 bg-gradient-to-br from-amber-50 via-white to-orange-50 p-6 shadow-sm sm:p-7">
        <p className="text-xs font-black uppercase tracking-[0.18em] text-amber-700">First agent template</p>
        <h2 className="mt-3 text-2xl font-black text-slate-950">Missed Call Text-Back</h2>
          ...
          {[
            ...
            <div key={number} className="rounded-2xl border border-white bg-white/80 p-4 shadow-sm">
              <div className="flex gap-3">
                <span className="grid h-8 w-8 shrink-0 place-items-center rounded-xl bg-amber-500 text-sm font-black text-white">
                  {number}
                </span>
                <div>
