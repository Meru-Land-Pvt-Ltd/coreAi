    ...
    >
      <nav className="mx-auto flex w-full max-w-none items-center justify-between gap-3 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden min-w-0 flex-1 items-center justify-center gap-4 md:flex lg:gap-7 xl:gap-8">
          ...
          <a data-testid="header-pricing-link" href={"/pricing"} className="text-sm font-medium text-slate-600 transition hover:text-slate-900">
            Pricing
          </a>

          <Link data-testid="header-about-link" href={"/about"} className="text-sm font-medium text-slate-600 transition hover:text-slate-900">
            About
          </Link>
