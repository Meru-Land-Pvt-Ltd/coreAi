                        ...
                        <div className="flex items-center gap-4 pr-8">
                            ...
                            <div className="min-w-0">
                                ...
                                <div className="mt-2 flex items-center gap-1.5">
                                    <span
                                        className="inline-flex min-w-0 items-center gap-1.5 rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-medium text-slate-600"
                                        data-testid="demo-setup-taxonomy"
                                    >
                                        <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
                                        <span className="truncate">
                                            {demoProfile.industry}
                                            <span className="mx-1 text-slate-300">/</span>
                                            {demoProfile.subindustry}
                                        </span>
                                    </span>

                                    {/* What demo mode can and cannot do — on hover/focus, not a wall of text. */}
                                    <span className="group relative shrink-0">
                                        <button
                                            type="button"
                                            aria-label="What demo mode does"
                                            data-testid="demo-setup-info"
                                            className="grid h-5 w-5 place-items-center rounded-full text-slate-300 transition-colors hover:text-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/30 group-focus-within:text-amber-500"
                                        >
                                        ...
                                        <span
                                            role="tooltip"
                                            className="pointer-events-none absolute left-1/2 top-full z-20 mt-2 w-72 -translate-x-1/2 rounded-xl bg-slate-900 px-3 py-2.5 text-[11px] font-normal leading-relaxed text-white opacity-0 shadow-xl shadow-slate-900/20 transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100"
                                        >
                                            <span className="absolute -top-1 left-1/2 h-2 w-2 -translate-x-1/2 rotate-45 rounded-[2px] bg-slate-900" />
