...
const privacySections: LegalSectionData[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "SMS consent is specific to the identified sending business and messaging program and is non-transferable. Consent provided to one business is never applied to, or usable by, another business using Triven.",
