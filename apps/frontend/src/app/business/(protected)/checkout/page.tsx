                        ...
                        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5 lg:gap-12">
                            <div className="order-2 space-y-6 lg:order-1 lg:col-span-3">
                                ...
                                <section>
                                    ...
                                    <p className="mt-3 text-center text-xs text-slate-400" data-testid="business-protected-checkout-you-apos-ll-be-charged-future-amount-text">
                                        You&apos;ll be charged{" "}
    ...
    return (
        <header className="sticky top-0 z-30 border-b border-gray-100 bg-white px-5 py-4 sm:px-8">
            <div className="mx-auto grid max-w-6xl grid-cols-3 items-center gap-2">
                <Link data-testid="checkout-logo-home-link" href={BUSINESS_MARKETPLACE_PATH} className="group flex w-fit items-center gap-2.5">
                    <span
                    ...
                    <span className="text-[1.35rem] font-extrabold tracking-tight text-slate-900 transition-colors group-hover:text-amber-600" data-testid="business-protected-checkout-core-text">
                        CORE
                    </span>
                </Link>
                ...
                <div className="text-right">
                    <Link data-testid="checkout-back-to-marketplace-link"
        ...
        <div className="lg:sticky lg:top-28">
            <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
                ...
                <div className="flex gap-4 border-b border-gray-50 px-6 py-5">
                    ...
                    <div className="min-w-0">
                        <p className="font-bold leading-tight text-slate-900" data-testid="business-protected-checkout-agent-text">{agent.name}</p>
                        <p className="mt-0.5 text-sm text-slate-500" data-testid="business-protected-checkout-by-agent-author-text">by {agent.author}</p>
                        <p className="mt-1 flex items-center gap-1 text-sm text-amber-500" data-testid="business-protected-checkout-agent-rating-agent-reviews-text">
                            <span>★★★★★</span>
                ...
                <div className="px-6 py-5">
                    ...
                    <div className="mt-2 flex justify-between text-sm">
                        <span className="text-slate-500" data-testid="business-protected-checkout-due-trial-date-text">Due {trialDate}</span>
                        <span className="tnum font-medium text-slate-500" data-testid="business-protected-checkout-future-amount-00-text">${futureAmount}.00</span>
                    </div>
                </div>
...
function ConfirmationView({
    ...
    return (
        <main className="fade-up mx-auto max-w-2xl px-5 py-14 text-center sm:py-16">
            ...
            <p className="mt-2 text-lg text-slate-600" data-testid="business-protected-checkout-agent-is-now-active-text">{agent.name} is now active.</p>
