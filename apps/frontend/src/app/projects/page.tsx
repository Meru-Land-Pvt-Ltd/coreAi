    ...
    <main className="min-h-screen bg-[#fff8ef] p-6 text-orange-950">
      <div className="mx-auto max-w-7xl">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.2em] text-orange-700">Projects</p>
            <h1 className="text-3xl font-bold">Custom Agent Requirements</h1>
          </div>
            ...
            <article key={project.title} className="rounded-3xl soft-card p-5">
              <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                <div>
                  ...
                  <p className="mt-1 text-sm text-orange-700">{project.budget}</p>
                ...
                <div className="text-left md:text-right">
                  <p className="text-sm font-semibold text-orange-700">{project.status}</p>
                  <button className="mt-3 rounded-full bg-orange-500 px-4 py-2 text-sm font-semibold text-white">
                    Send Proposal
                  </button>
                </div>
              </div>
