...
export default function HomePage() {
  ...
  return (
    <div data-testid="app-page-div-3" className="core-root min-h-screen text-slate-600">
      ...
      <main data-testid="app-page-main-1" id="top">
        <section data-testid="app-page-section-1" className="relative overflow-hidden px-6 pb-20 pt-36 sm:pt-44">
          ...
          <div data-testid="app-page-div-12" className="mx-auto max-w-4xl text-center">
            ...
            <p data-testid="app-page-p-1" className="mx-auto mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-slate-600 sm:text-xl">
              ...
              <span data-testid="app-page-span-7" className="font-semibold text-slate-900">AI Architects:</span> build agents that solve these problems and earn 70% of every sale.
            </p>
            ...
            <div data-testid="app-page-div-16" className="mx-auto mt-8 max-w-md rounded-xl border border-amber-200 bg-white p-2 shadow-sm">
              {!heroSent ? (
                <>
                  ...
                  {heroError ? (
                    <p className="px-2 pt-2 text-center text-xs font-medium text-red-600">
                      {heroError}
                    </p>
                  ) : null}
                </>
              ) : (
                <p data-testid="app-page-p-3" className="px-2 py-3 text-center text-sm font-semibold text-amber-600">
                  Check your inbox! Your assessment link is on the way.
                </p>
              )}

              <p data-testid="app-page-p-4" className="mt-1 px-2 text-center text-xs text-slate-500">
              ...
              <div data-testid="app-page-div-21" className="flex flex-col items-stretch gap-4 md:flex-row md:items-center md:gap-0">
                <div data-testid="app-page-div-22" className="flex flex-col items-center gap-3 rounded-xl border border-amber-200 bg-white px-6 py-5 text-center shadow-sm backdrop-blur md:min-w-[148px]">
                  <div data-testid="app-page-div-23" className="flex h-12 w-12 items-center justify-center rounded-xl bg-amber-50 text-amber-600 ring-1 ring-amber-300">
                    <svg data-testid="app-page-svg-7" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                      <path data-testid="app-page-path-6" d="M3.75 13.5 14.25 2.25 12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" />
                    </svg>
                  </div>
                ...
                <div data-testid="app-page-div-30" className="flex flex-col items-center gap-3 rounded-xl border border-amber-400 bg-white px-7 py-6 text-center shadow-sm shadow-glow backdrop-blur md:min-w-[160px]">
                  <div data-testid="app-page-div-31" className="flex h-14 w-14 items-center justify-center rounded-xl bg-amber-500 text-slate-950 shadow-glow animate-pulse-ring">
                    <svg data-testid="app-page-svg-8" className="h-7 w-7" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                      <path data-testid="app-page-path-7" d="M12 1.75 14.1 8.4 21 9.3l-5.1 4.1L17.5 21 12 17.2 6.5 21l1.6-7.6L3 9.3l6.9-.9L12 1.75Z" />
                    </svg>
                  </div>
                ...
                <div data-testid="app-page-div-38" className="flex flex-col items-center gap-3 rounded-xl border border-amber-200 bg-white px-6 py-5 text-center shadow-sm backdrop-blur md:min-w-[148px]">
                  <div data-testid="app-page-div-39" className="flex h-12 w-12 items-center justify-center rounded-xl bg-amber-50 text-amber-600 ring-1 ring-amber-300">
                    <svg data-testid="app-page-svg-9" className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                      <path data-testid="app-page-path-8" d="M4.5 12.75l6 6 9-13.5" />
                    </svg>
                  </div>
        ...
        <section data-testid="app-page-section-2" className="px-6">
          <div data-testid="app-page-div-43" className="relative isolate mx-auto mt-16 max-w-4xl animate-float overflow-visible rounded-2xl border border-gray-200 bg-white p-6 shadow-glow backdrop-blur-sm">
            ...
            <p data-testid="app-page-p-5" className="mt-4 text-center text-sm text-slate-500">
            ...
            <div data-testid="app-page-div-48" className="mt-14 grid gap-6 lg:grid-cols-2">
              <div data-testid="app-page-div-49" id="businesses" className="group scroll-mt-24 rounded-xl border border-gray-200 bg-white p-8 shadow-sm backdrop-blur-sm transition duration-300 hover:-translate-y-1 hover:border-amber-400 hover:shadow-glow sm:p-10">
                <div data-testid="app-page-div-50" className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-amber-50 text-amber-600 ring-1 ring-amber-300">
                  <svg data-testid="app-page-svg-11" className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <path data-testid="app-page-path-16" d="M3.75 21h16.5M5.25 21V5.25A1.5 1.5 0 0 1 6.75 3.75h6A1.5 1.5 0 0 1 14.25 5.25V21M14.25 9.75h3.75a1.5 1.5 0 0 1 1.5 1.5V21M8.25 7.5h2.25M8.25 11.25h2.25M8.25 15h2.25" />
                  </svg>
                </div>
              ...
              <div data-testid="app-page-div-51" id="architects" className="group scroll-mt-24 rounded-xl border border-gray-200 bg-white p-8 shadow-sm backdrop-blur-sm transition duration-300 hover:-translate-y-1 hover:border-amber-400 hover:shadow-glow sm:p-10">
                <div data-testid="app-page-div-52" className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-amber-50 text-amber-600 ring-1 ring-amber-300">
                  <svg data-testid="app-page-svg-12" className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <path data-testid="app-page-path-17" d="M21 7.5 12 2.25 3 7.5m18 0-9 5.25m9-5.25v9L12 21.75M3 7.5l9 5.25M3 7.5v9L12 21.75m0-9v9" />
                  </svg>
                </div>
                ...
                {[
                  ...
                  <div data-testid="app-page-div-64" key={n} className="contents">
                    <div data-testid="app-page-div-65" className="flex flex-1 items-center gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm backdrop-blur-sm transition hover:border-amber-400 hover:shadow-glow-sm">
                      ...
                      <div data-testid="app-page-div-66">
                        <div data-testid="app-page-div-67" className="font-semibold text-slate-900">{title}</div>
                        <div data-testid="app-page-div-68" className="text-sm text-slate-500">{sub}</div>
                      </div>
                    </div>

                    {i < 2 ? (
                      <div data-testid="app-page-div-69" className="flex items-center justify-center px-2">
                        <div data-testid="app-page-div-70" className="hidden h-px w-8 bg-gradient-to-r from-amber-500/50 to-amber-500/20 md:block" />
                        <div data-testid="app-page-div-71" className="h-6 w-px bg-gradient-to-b from-amber-500/50 to-amber-500/20 md:hidden" />
                      </div>
                    ) : null}
                  </div>
                ))}
                ...
                {[
                  ...
                  <div data-testid="app-page-div-75" key={n} className="contents">
                    <div data-testid="app-page-div-76" className="flex flex-1 items-center gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm backdrop-blur-sm transition hover:border-amber-400 hover:shadow-glow-sm">
                      ...
                      <div data-testid="app-page-div-77">
                        <div data-testid="app-page-div-78" className="font-semibold text-slate-900">{title}</div>
                        <div data-testid="app-page-div-79" className="text-sm text-slate-500">{sub}</div>
                      </div>
                    </div>

                    {i < 2 ? (
                      <div data-testid="app-page-div-80" className="flex items-center justify-center px-2">
                        <div data-testid="app-page-div-81" className="hidden h-px w-8 bg-gradient-to-r from-amber-500/50 to-amber-500/20 md:block" />
                        <div data-testid="app-page-div-82" className="h-6 w-px bg-gradient-to-b from-amber-500/50 to-amber-500/20 md:hidden" />
                      </div>
                    ) : null}
                  </div>
                ))}
      ...
      >
        <div data-testid="app-page-div-114" className="mx-auto flex w-full max-w-none flex-col items-stretch justify-between gap-2 sm:flex-row sm:items-center sm:gap-4">
          <p data-testid="app-page-p-19" className="text-sm text-slate-600">
        ...
        >
          <div data-testid="app-page-div-116" role="dialog" aria-modal="true" aria-labelledby="exit-title" className="relative w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-2xl">
            <button
              ...
              aria-label="Close"
            >
              <svg data-testid="app-page-svg-14" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path data-testid="app-page-path-18" d="M6 6l12 12M18 6L6 18" />
              </svg>
            </button>

            <h2 data-testid="app-page-h2-6" id="exit-title" className="pr-8 text-2xl font-bold tracking-tight text-slate-900">
              Wait! don&apos;t leave empty-handed.
            </h2>

            <p data-testid="app-page-p-20" className="mt-3 text-sm leading-relaxed text-slate-500">
            ...
            {!exitSent ? (
              ...
              <p data-testid="app-page-p-21" className="mt-4 text-center text-sm font-semibold text-amber-600">
                Check your inbox! Your assessment link is on the way.
              </p>
            )}

            <p data-testid="app-page-p-22" className="mt-4 text-center text-xs text-slate-500">
      ...
      <div data-testid="app-page-div-117" className="fixed right-6 z-50 flex flex-col items-end gap-3 transition-all duration-300" style={{ bottom: stickyShown ? "5.5rem" : "1.5rem" }}>
        {chatOpen ? (
          <div data-testid="app-page-div-118" className="relative w-64 rounded-2xl border border-gray-200 bg-white p-4 shadow-lg">
            <button data-testid="app-page-button-6" type="button" onClick={() => setChatOpen(false)} className="absolute -right-2 -top-2 inline-flex h-6 w-6 items-center justify-center rounded-full border border-gray-200 bg-white text-slate-500 transition hover:text-slate-900" aria-label="Close chat">
              <svg data-testid="app-page-svg-15" className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.4} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path data-testid="app-page-path-19" d="M6 6l12 12M18 6L6 18" />
              </svg>
            </button>

            <p data-testid="app-page-p-23" className="text-sm text-slate-600">
        ...
        <button data-testid="app-page-button-7" type="button" onClick={() => setChatOpen((o) => !o)} className="flex h-14 w-14 items-center justify-center rounded-full bg-amber-500 text-slate-950 shadow-glow transition hover:scale-110" aria-label="Open chat">
          <svg data-testid="app-page-svg-16" className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <path data-testid="app-page-path-20" d="M7.5 8.5h9M7.5 12h6M21 11.5a8.5 8.5 0 0 1-12.2 7.7L3 21l1.8-5.8A8.5 8.5 0 1 1 21 11.5z" />
          </svg>
        </button>
      </div>
    </div>
